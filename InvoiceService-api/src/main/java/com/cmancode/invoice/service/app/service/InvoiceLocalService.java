...
public interface InvoiceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.cmancode.invoice.service.app.service.impl.InvoiceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the invoice local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link InvoiceLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Invoice deleteInvoice(long invoiceId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Invoice getInvoice(long invoiceId) throws PortalException;
