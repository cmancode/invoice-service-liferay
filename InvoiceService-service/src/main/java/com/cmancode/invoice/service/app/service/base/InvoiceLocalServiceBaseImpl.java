...
package com.cmancode.invoice.service.app.service.base;

import com.cmancode.invoice.service.app.model.Invoice;
import com.cmancode.invoice.service.app.service.InvoiceLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.cmancode.invoice.service.app.service.impl.InvoiceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.cmancode.invoice.service.app.service.impl.InvoiceLocalServiceImpl
 * @generated
 */
public abstract class InvoiceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, InvoiceLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>InvoiceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>InvoiceLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return invoicePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Invoice.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return invoicePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return invoicePersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(invoiceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Invoice.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Invoice.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return invoicePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return invoiceLocalService.deleteInvoice((Invoice)persistedModel);
	}

	@Override
	public BasePersistence<Invoice> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			InvoiceLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		invoiceLocalService = (InvoiceLocalService)aopProxy;

		_setLocalServiceUtilService(invoiceLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return InvoiceLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = InvoiceLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, invoiceLocalService);
		}
